...
#############################################
TotalStart = DT.datetime(2015,10,01)
...
for date in surveyDate:
    for type in ['cBKF_T', 'cBKF', '']:
        ...
        bathy = gdTB.getBathyIntegratedTransect(type)
        ...
        fname='/home/number/Public/paperFigs/XshoreSmooth_{}_'.format(date.strftime('%Y%m%d'))
