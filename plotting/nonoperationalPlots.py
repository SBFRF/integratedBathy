...
def plotUnstructBathy(ofname, pDict):
    ...
    pDict['z'][pDict['z'] < pDict['cbarMin']] = pDict['cbarMin']
    pDict['z'][pDict['z'] > pDict['cbarMax']] = pDict['cbarMax']
    ...
    clev = np.arange(pDict['z'].min(), pDict['z'].max(), 1/float(pDict['ncLev']))
    plt.tricontourf(triang, pDict['z'], clev, cmap=plt.get_cmap(pDict['cbarColor']))
